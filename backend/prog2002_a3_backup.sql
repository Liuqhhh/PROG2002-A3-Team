...
--
-- Host: 127.0.0.1    Database: prog2002_a3
-- ------------------------------------------------------
...
--
-- Current Database: `prog2002_a3`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `prog2002_a3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `events` VALUES (1,'慈善音乐会','为贫困儿童筹款的音乐晚会，邀请知名音乐家表演','2025-11-15','悉尼歌剧院',50.00,200,'2025-10-17 18:05:29'),(2,'环保清洁日','社区海滩清洁志愿者活动，保护海洋环境','2025-10-20','邦迪海滩',0.00,100,'2025-10-17 18:05:29'),(3,'慈善拍卖会','艺术品和收藏品拍卖，所有收益捐赠给儿童医院','2025-12-05','市政厅',100.00,50,'2025-10-17 18:05:29'),(4,'马拉松筹款','10公里慈善跑步活动，为癌症研究筹款','2025-09-30','百年纪念公园',25.00,300,'2025-10-17 18:05:29'),(5,'烘焙义卖','自制蛋糕和饼干义卖，支持本地动物收容所','2025-10-25','社区中心',5.00,150,'2025-10-17 18:05:29');
...
INSERT INTO `registrations` VALUES (1,1,'张三','zhang@example.com',2,'2025-10-17 18:05:47'),(2,1,'李四','li@example.com',1,'2025-10-17 18:05:47'),(3,1,'王五','wang@example.com',4,'2025-10-17 18:05:47'),(4,2,'赵六','zhao@example.com',1,'2025-10-17 18:05:47'),(5,2,'钱七','qian@example.com',3,'2025-10-17 18:05:47'),(6,3,'孙八','sun@example.com',2,'2025-10-17 18:05:47'),(7,3,'周九','zhou@example.com',1,'2025-10-17 18:05:47'),(8,4,'吴十','wu@example.com',2,'2025-10-17 18:05:47'),(9,4,'郑十一','zheng@example.com',1,'2025-10-17 18:05:47'),(10,5,'王十二','wang12@example.com',5,'2025-10-17 18:05:47');
/*!40000 ALTER TABLE `registrations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'prog2002_a3'
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-10-03 06:30:00',NULL),('diagnostics.include_raw','OFF','2025-10-03 06:30:00',NULL),('ps_thread_trx_info.max_length','65535','2025-10-03 06:30:00',NULL),('statement_performance_analyzer.limit','100','2025-10-03 06:30:00',NULL),('statement_performance_analyzer.view',NULL,'2025-10-03 06:30:00',NULL),('statement_truncate_len','64','2025-10-03 06:30:00',NULL);
...
INSERT INTO `categories` VALUES (1,'Fun Run'),(2,'Gala Dinner'),(3,'Silent Auction'),(4,'Concert');
...
LOCK TABLES `events` WRITE;
/*!40000 ALTER TABLE `events` DISABLE KEYS */;
INSERT INTO `events` VALUES (1,'City Marathon 2025','Annual city marathon for heart disease research.','A full description of the marathon route, sponsors, and activities.','2025-10-15 08:00:00','Central Park','Raise funds for Heart Foundation',50.00,50000.00,32500.00,1,1),(2,'Charity Gala Night','An elegant evening to support local shelters.','Detailed agenda, guest speakers, and menu for the night.','2025-09-20 19:00:00','Grand Hotel Ballroom','Support homeless shelters',150.00,20000.00,12000.00,2,1),(3,'Past Concert Example','A concert that already happened.','Details...','2024-07-01 18:00:00','City Hall','Raise awareness for music education',25.00,10000.00,9500.00,4,1);
/*!40000 ALTER TABLE `events` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'charityevents_db'
--
...
-- Dump completed on 2025-10-18  2:21:14
